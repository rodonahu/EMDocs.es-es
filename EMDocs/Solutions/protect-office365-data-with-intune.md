---
title: Proteger los datos de la empresa de Office 365 con Microsoft Intune | Microsoft Intune
description: 
keywords: 
author: jeffgilb
manager: angrobe
...
# Proteger los datos de la empresa de Office 365 con Intune
...
## ¿Cómo puede ayudarle Enterprise Mobility + Security (EMS)?
...
## Inscribir dispositivos móviles y PC Windows en la administración
...
## Proteger el acceso a servicios de Office 365
...
> <sup>1</sup> Solo iOS y Android, <sup>2</sup> Dispositivos iOS, Android y Windows

### Proteger el acceso a Exchange Online
...
### Proteger el acceso a SharePoint Online
...
### MAM para dispositivos móviles iOS y Android administrados
...
### Windows Information Protection (WIP) para dispositivos móviles y equipos con Windows 10 administrados
...
## Borrar datos de la empresa de forma selectiva
...
[Escenarios de productividad móvil administrada](https://docs.microsoft.com/enterprise-mobility/solutions/managed-mobile-productivity)
