...
Si su entorno incluye Exchange Online y Exchange Server local, puede obtener información sobre cómo [implementar Exchange Online y Exchange Server local con Microsoft Intune y Configuration Manager](../Solutions/conditional-access-intune-configmgr-coexist.md).
