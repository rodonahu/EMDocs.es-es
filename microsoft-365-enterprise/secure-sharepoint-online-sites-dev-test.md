...
description: "Cree sitios de grupo de SharePoint Online públicos, privados, confidenciales y extremadamente confidenciales en un entorno de desarrollo y prueba."
...
Este artículo proporciona instrucciones paso a paso para crear un entorno de desarrollo y prueba que incluya los cuatro tipos diferentes de sitios de grupo de SharePoint Online de la [solución Proteger sitios y archivos de SharePoint Online](secure-sharepoint-online-sites-and-files.md).

Use este entorno de desarrollo y prueba para experimentar con los comportamientos de protección de la información y ajustar la configuración a las necesidades concretas antes de implementar sitios de grupo de SharePoint Online en producción.

## <a name="phase-1-create-your-devtest-environment"></a>Fase 1: Crear el entorno de desarrollo y prueba
...
En primer lugar, siga las instrucciones de la **fase 2** del [entorno de desarrollo y prueba de Office 365](https://technet.microsoft.com/library/mt736406.aspx).

Luego regístrese en la **suscripción de evaluación de EMS**, agréguela a la misma organización que la suscripción de evaluación de Office 365 y después siga estos pasos:
...
3. En la pestaña **Centro de administración de Office** del explorador, en el panel izquierdo, haga clic en **Facturación > Servicios de compra**.
4. En la página **Servicios de compra**, busque el elemento **Enterprise Mobility + Security E5** y luego mantenga el puntero sobre él y haga clic en **Iniciar evaluación gratuita**.
5. En la página **Confirmar pedido**, haga clic en **Probar ahora**.
6. En la página **Recibo del pedido**, haga clic en **Continuar**.

Luego habilite la licencia de Enterprise Mobility + Security E5 para la cuenta de administrador global.

1. En la pestaña **Centro de administración de Office 365** del explorador, en el panel izquierdo, haga clic en **Usuarios > Usuarios activos**.
...
En esta fase se crean y configuran los grupos y usuarios de Azure AD de la organización ficticia.
...
Luego ejecute estos comandos desde el símbolo del sistema de PowerShell o el entorno de script integrado (ISE):
```
...
Después configure la concesión de licencias automática para que se asignen licencias de forma automática a los miembros de los grupos para las suscripciones de Office 365 y EMS y luego siga estos pasos:
...
>[!Note]
>El uso de una contraseña común aquí es para automatizar y facilitar la configuración de un entorno de desarrollo y prueba. No se recomienda para suscripciones de producción.
>
...
4. En el panel que muestra las propiedades de la cuenta de usuario **CEO**, compruebe que se le has asignado las licencias **Enterprise Mobility + Security E5** y **Office 365 Enterprise E5** (en **Licencias de productos**).
...
7. En el panel **Inicio > Etiquetas**, haga clic para **publicar etiquetas**.
8. En el panel **Choose labels to publish** (Elegir las etiquetas que se van a publicar), haga clic en **Choose labels to publish**.
...
Para crear un sitio de grupo de base de referencia público de SharePoint Online, haga lo siguiente:
...
5. En **Nombre del sitio**, escriba **De organización**.
6. En la **descripción del sitio de grupo**, escriba **Sitio de SharePoint para toda la organización**.
...
Luego configure la carpeta documentos del sitio de grupo De organización para la etiqueta Interno público.

1. En la pestaña **De organización-Inicio** del explorador, haga clic en **Documentos**.
...
Para crear un sitio de grupo de base de referencia privado de SharePoint Online para un proyecto de la organización, haga lo siguiente:
...
6. En la **descripción del sitio de grupo**, escriba **Sitio de SharePoint para Proyecto 1**.
...
Luego configure la carpeta documentos del sitio de grupo Proyecto 1 para la etiqueta Privado.
...
A continuación se muestra la configuración resultante.
 ...
 ![Protección de sitios de grupo privada](./media/secure-sharepoint-online-sites-dev-test/privsite.png)

### <a name="marketing-campaigns-team-site"></a>Sitio de grupo Campañas de marketing

Para crear un sitio de grupo aislado de nivel confidencial de SharePoint Online para recursos de campaña de marketing, haga lo siguiente:

1. Con un explorador en el equipo local, inicie sesión en el **portal de Office 365** con la cuenta de administrador global. Para obtener ayuda, vea [Where to sign in to Office 365](https://support.office.com/Article/Where-to-sign-in-to-Office-365-e9eb7d51-5430-4929-91ab-6157c5a050b4) (Dónde iniciar sesión en Office 365).
2. En la lista de iconos, haga clic en **SharePoint**.
...
3. En **Team site name** (Nombre del sitio de grupo), escriba **Campañas de marketing**.
4. En **Team site description** (Descripción del sitio de grupo), escriba **Sitio de SharePoint para recursos de campaña de marketing (confidencial)**.
5. En **Configuración de privacidad**, seleccione **Privado: solo los miembros pueden acceder a este sitio** y haga clic en **Siguiente**.
6. En el panel **Who do you want to add?** (Usuarios que quiere agregar), haga clic en **Finalizar**.
...
11. Haga clic en **Miembros de Campañas de Marketing** en la lista.
...
15. Haga clic en el botón Atrás del explorador y luego en **Propietarios de Campañas de marketing** en la lista.
...
A continuación se muestran los resultados de la configuración de los permisos:

* El grupo de SharePoint **Miembros de Campañas de marketing** solo contiene el grupo **Campañas de marketing** (que contiene la cuenta de usuario de administrador global), el grupo **Marketing staff** (que contiene las cuentas de usuario Marketing1 y Marketing2) y la cuenta de usuario **Researcher1**.
* El grupo de SharePoint **Propietarios de Campañas de marketing** solo contiene el grupo **IT staff** (que contiene únicamente las cuentas de usuario ITAdmin1 y ITAdmin2).
* El grupo de SharePoint **Visitantes de Campañas de marketing** no contiene grupos ni cuentas de usuario.
* Los miembros no pueden modificar los permisos de nivel de sitio (esto solo pueden hacerlo los miembros del grupo **Propietarios de Campañas de marketing**).
* Otras cuentas de usuario no pueden acceder al sitio ni a sus recursos, pero pueden solicitar acceso al sitio, que envía un correo electrónico al buzón de la cuenta de usuario _ITAdmin1_.

Luego configure la carpeta de documentos del sitio de grupo Campañas de marketing para la etiqueta Confidencial.
...
13. En el panel sobre **qué quiere hacer si se detecta información confidencial**, haga clic para **personalizar la sugerencia y el correo electrónico**.
 ...
 * Para compartir con un usuario de fuera de la organización, descargue el archivo y luego ábralo. Haga clic en **Archivo**, en **Proteger documento**, en **Cifrar con contraseña** y especifique una contraseña segura. Envíe la contraseña en un correo electrónico diferente u otro medio de comunicación.
...
Para crear un sitio de grupo aislado de SharePoint Online en el nivel altamente confidencial para recursos estratégicos de empresa de los directores ejecutivos de la organización, haga lo siguiente:
...
4. En **Configuración de privacidad**, seleccione **Privado: solo los miembros pueden acceder a este sitio** y haga clic en **Siguiente**.
5. En el panel **Who do you want to add?** (Usuarios que quiere agregar), haga clic en **Finalizar**.
...
10. Haga clic en **Miembros de Estrategia de empresa** en la lista y, en la página **Personas y grupos**, haga clic en **Nuevo**.
11. En el cuadro de diálogo **Compartir**, escriba **C-Suite** (Directivos), selecciónelo y haga clic en **Compartir**.
12. Haga clic en **Propietarios de Estrategia de empresa** en la lista y, en la página **Personas y grupos**, haga clic en **Nuevo**.
...
* El grupo de SharePoint **Miembros de Estrategia de empresa** solo contiene el grupo **C-Suite** (que contiene únicamente las cuentas de usuario CEO, CFO y CIO) y el grupo **Estrategia de empresa** (que contiene únicamente la cuenta de usuario de administrador global).
* El grupo de SharePoint **Propietarios de Estrategia de empresa** solo contiene el grupo **IT staff** (que contiene únicamente las cuentas de usuario _ITAdmin1_ e _ITAdmin2_).
* El grupo de SharePoint **Visitantes de Estrategia de empresa** no contiene grupos ni cuentas de usuario.
* Los miembros no pueden modificar los permisos de nivel de sitio (esto solo pueden hacerlo los miembros del grupo **Propietarios de Estrategia de empresa**).
* Otras cuentas de usuario no pueden acceder al sitio o a sus recursos ni solicitar acceso al sitio. Los permisos adicionales para el sitio deben ser asignados por el administrador global o por un miembro del grupo **Propietarios de Estrategia de empresa**.

Luego configure la carpeta documentos del sitio de grupo Estrategia de empresa para la etiqueta Extremadamente confidencial.
...
14. En el panel sobre **qué quiere hacer si se detecta información confidencial**, haga clic para **personalizar la sugerencia y el correo electrónico**.
 ...
 * Para compartir con un usuario de fuera de la organización, descargue el archivo y luego ábralo. Haga clic en **Archivo**, en **Proteger documento**, en **Cifrar con contraseña** y especifique una contraseña segura. Envíe la contraseña en un correo electrónico diferente u otro medio de comunicación.
17. En el panel sobre **qué quiere hacer si se detecta información confidencial**, seleccione para **exigir una justificación de empresa para invalidar** y haga clic en **Siguiente**.
...
Después configure la etiqueta Extremadamente confidencial de Azure Information Protection con protección y permisos y realice los pasos siguientes:
...
Para proteger un documento con Azure Information Protection y la etiqueta Extremadamente confidencial, debe [instalar el cliente de Azure Information Protection](https://docs.microsoft.com/information-protection/rms-client/install-client-app) en un equipo de prueba, instalar Office desde el portal de Office 365 y luego iniciar sesión desde Microsoft Word con una cuenta del grupo C-Suite de la suscripción de evaluación.
...
Ahora está listo para crear documentos en estos cuatro sitios y para probar el acceso a ellos con diferentes cuentas de usuario de la suscripción de evaluación.

A continuación se muestra la configuración global de los cuatro sitios de grupo de SharePoint Online.

 ![Configuración final](./media/secure-sharepoint-online-sites-dev-test/finalconfig.png)

Cuando esté listo para la implementación en producción de sitios seguros de SharePoint Online, vea [Proteger sitios y archivos de SharePoint Online](https://technet.microsoft.com/library/mt842190.aspx) para obtener información detallada y vínculos a artículos de implementación paso a paso.
