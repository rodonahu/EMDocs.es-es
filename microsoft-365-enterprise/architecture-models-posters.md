...
Las capacidades se recomiendan en tres niveles: protección de base de referencia, protección confidencial y protección para entornos con datos muy regulados o clasificados.
...
[![Escritorio moderno y seguro](./media/architecture-models-posters/image13.png)](https://www.microsoft.com/download/details.aspx?id=55987)
...
### <a name="change-management-for-office-365-clients"></a>Administración de cambios para clientes de Office 365
 ...
 [![Administración de cambios](./media/architecture-models-posters/image4.png)](https://www.microsoft.com/download/details.aspx?id=49141)
...
|**Elemento**|**Descripción**|
|:-----|:-----|
| [![Redes de nube](./media/architecture-models-posters/image7.png)](https://www.microsoft.com/download/details.aspx?id=54425)|Este modelo contiene: <ul><li>Adaptación de la red para la conectividad en la nube</li><li>Elementos comunes de la conectividad en la nube de Microsoft</li><li>ExpressRoute para la conectividad en la nube de Microsoft</li><li>Diseño de redes para Microsoft SaaS (Office 365, Microsoft Intune y Dynamics CRM Online)</li><li>Adaptación de la red para Azure PaaS</li>Adaptación de la red para Azure IaaS<li></ul></li>Vea [Optimize Your Network for Microsoft Cloud Offerings](https://mva.microsoft.com/training-courses/optimize-your-network-for-microsoft-cloud-offerings-17743) (Optimizar la red para las ofertas de nube de Microsoft), un nuevo curso de Microsoft Virtual Academy basado en este póster de arquitectura.|
...
|**Elemento**|**Descripción**|
|:-----|:-----|
| [![Nube híbrida](./media/architecture-models-posters/image8.png)](https://www.microsoft.com/download/details.aspx?id=54424)|Este modelo contiene: <ul><li>Información general sobre la nube híbrida </li><li>Arquitectura de los escenarios de nube híbrida de Microsoft </li><li>Escenarios de nube híbrida para Microsoft SaaS (Office 365) </li><li>Escenarios de nube híbrida para Azure PaaS </li><li>Escenarios de nube híbrida para Azure IaaS </ul></li>|

[PDF](https://go.microsoft.com/fwlink/p/?linkid=842082) | [Visio](https://go.microsoft.com/fwlink/p/?linkid=842083) | [Artículo](https://technet.microsoft.com/library/mt750500.aspx) | [Más idiomas](https://www.microsoft.com/download/details.aspx?id=54424)
...
|**Elemento**|**Descripción**|
|:-----|:-----|
| [![Almacenamiento en la nube](./media/architecture-models-posters/image10.png)](https://www.microsoft.com/download/details.aspx?id=49552)|Este modelo contiene: <ul><li>Motivos para usar el almacenamiento en la nube y los escenarios clave </li><li>Opciones de almacenamiento en la nube incluidas en los servicios existentes </li><li>Opciones de almacenamiento que puede usar como punto de partida para su solución de almacenamiento </li><li>Bloques de creación de almacenamiento para crear una solución de almacenamiento propia o almacenamiento para las aplicaciones</ul></li>|
...
|**Elemento**|**Descripción**|
|:-----|:-----|
| [![Contoso en la nube](./media/architecture-models-posters/image11.png)](https://www.microsoft.com/download/details.aspx?id=54427)|Este modelo contiene: <ul><li>Información general sobre Contoso Corporation </li><li>Infraestructura de TI y necesidades de Contoso </li><li>Redes en la nube de Contoso</li><li>Identidad en la nube de Contoso</li><li>Suscripciones, licencias y cuentas de usuario de Contoso</li><li>Seguridad en la nube de Contoso</li><li>Escenarios de nube de empresa de Contoso</ul></li>|
